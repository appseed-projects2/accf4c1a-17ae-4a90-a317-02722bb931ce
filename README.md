...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-15 16:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/accf4c1a-17ae-4a90-a317-02722bb931ce.git
$ cd accf4c1a-17ae-4a90-a317-02722bb931ce
```
